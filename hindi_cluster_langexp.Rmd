...
hindi_langexp_cor <- cor(langexp_scores, method="pearson") #method="spearman")
...
set.seed(168)
# Run clustering
clust_km <- kmeans(dist(langexp_scaled), 3)
...
langexp_final_data_km <- 
  cbind(hindi_groups, cluster3 = clust_km$cluster) %>%
  cbind(langexp_scores)
