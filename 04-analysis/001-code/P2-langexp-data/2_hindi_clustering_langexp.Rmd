...
#### Load in Data
```{r}
processing_out_path <- file.path(PROJECT_DIR, '04-analysis', '002-pipeline', PHASE, "1_hindi_processing", "out")

load(file=file.path(processing_out_path, "hindi.RData"))
load(file=file.path(processing_out_path, "hindi_subj.RData"))
load(file=file.path(processing_out_path, "hindi_groups.RData"))
```
